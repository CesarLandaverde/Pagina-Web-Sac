    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="menu">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="./Sobre Nosotros.html"><strong>Sobre nostros</strong></a>
            </li>
          <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="./Contactanos.html"><strong>Contactanos</strong></a>
            </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu bg-secondary" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item  text-light" href="manual del grupo.html"><strong>Licencia</strong></a></li>
              <li><a class="dropdown-item text-light" href="info del ptc.html"><strong>Tematica PTC</strong></a><li>   
            </ul>
          </li>
        </ul>
